...
const registerUserMutation = (
  args: QUERIES.MutationPayload<MODELS.ICreateUser>,
) => {
...
const forgotPasswordInitMutation = (
  args: QUERIES.MutationPayload<MODELS.IForgotPasswordInit>,
) => {
  return QUERIES.useCustomMutation({
    mutationKey: [Constants.AUTH_KEYS.FORGET_PASSWORD_INIT],
    mutationFn: ({ payload }) =>
      authServiceInstance().forgot_password(payload!),
    options: args.mutationOptions,
  });
};
const resetPasswordMutation = (
  args: QUERIES.MutationPayload<MODELS.IResetPassword>,
) => {
  return QUERIES.useCustomMutation({
...
const sendEmailVerificationMutation = (
  ...
  return QUERIES.useCustomMutation({
    ...
    mutationFn: ({ payload }) =>
      authServiceInstance().send_verification_email(payload!),
    options: args.mutationOptions,
  });
};
...
const checkEmailMutation = (
  ...
  return QUERIES.useCustomMutation({
    ...
    mutationFn: ({ payload }) =>
      authServiceInstance().check_email(payload?.email!),
    options: args.mutationOptions,
  });
};
