          ...
          <Center>
            <VStack maxW={'5xl'} mx={'auto'} spaceY={8} position={'relative'} overflow={'hidden'}>
              ...
              <MotionBox
                ...
                textAlign={'center'}
              >
                <BaseText fontSize={{ base: 'lg', sm: 'xl' }} fontWeight={'bold'}>
                  🎉 Presque terminé !
                </BaseText>

                <BaseText fontSize={'lg'} maxW={'lg'} mx={'auto'}>
                  Un lien sécurisé de réinitialisation a été envoyé à votre adresse email. Consultez
                  votre boîte de réception pour finaliser l’opération.
                </BaseText>
              </MotionBox>
            </VStack>
          </Center>
