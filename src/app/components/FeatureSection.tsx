...
const features = [
  {
    icon: Icons.Zap,
    title: 'Ultra rapide',
    description: 'Interface optimisée pour des interactions instantanées et fluides.',
  ...
  },
  {
    ...
    description: "Gérez vos biens depuis n'importe quel appareil, à tout moment.",
      ...
      <Container mx="auto" px={{ base: 6, sm: 8 }}>
        ...
        >
          ...
          <BaseText variant={TextVariant.L} mb={2} mt={1} color={'gray.400'}>
            Des fonctionnalités pensées pour simplifier la gestion locative au quotidien.
          </BaseText>
        </MotionBox>
