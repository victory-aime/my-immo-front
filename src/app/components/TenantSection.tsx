...
const tenantFeatures = [
  ...
  },
  {
    ...
    description: 'Payez votre loyer en ligne en toute sécurité, avec confirmation instantanée.',
  ...
  },
  {
    ...
    description: "Suivez vos contrats, dates de renouvellement et conditions en un coup d'œil.",
  ...
  },
  {
    ...
    description: "Signalez un problème en quelques clics et suivez l'avancement en temps réel.",
  ...
  },
  {
    ...
    description: 'Recevez des rappels pour les échéances, paiements et mises à jour importantes.',
    iconColor: VariablesColors.primary,
    color: 'primary',
  },
  {
    ...
    description: 'Accédez à tous vos documents contractuels de manière digitale et sécurisée.',
      ...
      <Container mx="auto" px={{ base: 6, sm: 8 }}>
        ...
        >
          ...
          >
            <Box
              ...
              color={'tertiary.500'}
            />
            <BaseText color={'tertiary.500'} textTransform={'uppercase'} fontWeight={'semibold'}>
              Espace locataire
            </BaseText>
          </Flex>
          ...
          <BaseText variant={TextVariant.L} mb={2} mt={1} color={'gray.400'}>
            Une interface intuitive pour simplifier chaque étape de votre expérience locative.
          </BaseText>
        </MotionVStack>
        ...
        >
          <Link href={APP_ROUTES.ROOT}>
            <BaseButton colorType={'tertiary'} rightIcon={<Icons.ArrowRight />} mt={10}>
