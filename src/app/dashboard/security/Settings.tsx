...
export const Settings = () => {
  ...
  const [openCloseSessionModal, setOpenCloseSessionModal] =
    useState<boolean>(false);
  const [isRevoke, setIsRevoke] = useState<boolean>(false);
  const [listPasskey, setListPasskey] = useState<
    MODELS.IUserPasskeyList[] | undefined
  >([]);
  ...
  const [validateDisabledAccount, setValidateDisabledAccount] =
    useState<boolean>(false);
              ...
              {!extractorProviderId && (
                ...
                >
                  ...
                  {(listPasskey?.length ?? 0) > 0 ? (
                            ...
                            <>
                              <VStack alignItems="flex-start" gap={1}>
                                <BaseText fontWeight="bold">
                                  {cred.name ||
                                    t("PROFILE.SECURITY.UNKNOW_DEVICE")}
                                </BaseText>
                    ...
                    <BaseText mt={8}>
                      {t("PROFILE.SECURITY.PASS_KEY_NO_FOUND")}
                    </BaseText>
                  )}
                </ProfileForm>
              )}
                            ...
                            >
                              ...
                              <HStack>
                                ...
                                <BaseText>
                                  ...
                                  {formatCreatedAt(
                                    session?.createdAt as unknown as string,
                                  )}
                                </BaseText>
                              </HStack>
                              ...
                              <HStack>
                                ...
                                <BaseText>
                                  Expires le:{" "}
                                  {formatDisplayDate(session?.expiresAt)}
                                </BaseText>
                              </HStack>
                            </Flex>
                          </VStack>
