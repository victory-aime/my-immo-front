...
export const BuildingDelete = ({ isOpen, isLoading, callback, onChange, data }: ModalOpenProps) => {
  return (
    ...
    >
      <BaseText textAlign={'center'} fontSize={'sm'}>
        ...
        <Span color={'primary.500'}> {data?.name}</Span> ? Cette action est irréversible et
        supprimera également toutes les propriétes associées.
      </BaseText>
    </DeleteModalAnimation>
  );
};
