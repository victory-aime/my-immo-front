...
export const createBuildingSchema = Yup.object().shape({
  ...
  buildingOwner: Yup.string().required('Le nom du propriétaire du bâtiment est obligatoire.'),
  ...
  district: Yup.string().min(5, 'Le quartier doit contenir au moins 5 caractères.'),
